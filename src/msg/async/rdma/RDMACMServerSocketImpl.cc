...
RDMACMServerSocketImpl::RDMACMServerSocketImpl(CephContext *cct, Infiniband* i,
...
int RDMACMServerSocketImpl::accept(ConnectedSocket *sock, const SocketOptions &opt,
    entity_addr_t *out, Worker *w)
{
  ...
  RDMACMConnectedSocketImpl* server =
    new RDMACMConnectedSocketImpl(cct, infiniband, dispatcher, dynamic_cast<RDMAWorker*>(w), &info);
...
void RDMACMServerSocketImpl::abort_accept()
{
