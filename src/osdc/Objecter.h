...
public:
 ...
 public:
  ...
  struct op_target_t {
    ...
    vector<int> acting; ///< set of acting osds for last pg we mapped
			///  to

    int up_primary; ///< primary for last pg we mapped to based on the up set
    int acting_primary; ///< primary for last pg we mapped to based on
			///  the acting set
  ...
  struct NListContext {
    ...
    NListContext() : current_pg(0), current_pg_epoch(0), starting_pg_num(0),
		     at_end_of_pool(false), at_end_of_pg(false),
		     pool_id(0), pool_snap_seq(0), max_entries(0),
		     nspace(), bl(), list(), filter(),
		     extra_info(), ctx_budget(-1) {}
  ...
  struct ListContext {
    ...
    ListContext() : current_pg(0), current_pg_epoch(0), starting_pg_num(0),
		    at_end_of_pool(false), at_end_of_pg(false), pool_id(0),
		    pool_snap_seq(0), max_entries(0), nspace(), bl(),
		    list(), filter(), extra_info(), ctx_budget(-1) {}
